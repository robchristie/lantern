...
| --- | --- | --- | --- | --- | --- |
| Pointer, wheel, crop and cleanup guidance | Archive pointer commits above | Pending reviewed landing | Canonical validation passed 160 tests; browser smoke pending | Candidate | Recovered historical plan: `../completed/2026-05-28-pointer-wheel-screenshot-region.md`; current PR and local smoke evidence |
